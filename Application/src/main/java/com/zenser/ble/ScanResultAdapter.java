...
public class ScanResultAdapter extends BaseAdapter {
    ...
    private static final String LOG_TAG = "ScanResultAdapter";
    ...
    private int getSignalStrengthIndication(int rssi){
        if(rssi > -55){
            return R.drawable.ic_signal_4_32dp;
        }
        if (rssi > -65){
            return R.drawable.ic_signal_3_32dp;
        }
        if(rssi > -80){
            return R.drawable.ic_signal_2_32dp;
        }
        if(rssi > -95){
            return R.drawable.ic_signal_1_32dp;
        }
        return R.drawable.ic_signal_0_32dp;
