 ...
 */
public class BleScannerActivity extends FragmentActivity {

    private static final int REQUEST_CODE_ASK_MULTIPLE_PERMISSIONS = 1001;
    private static final String LOG_TAG = "BleScannerActivity";
        ...
        switch (requestCode) {
            case REQUEST_CODE_ASK_MULTIPLE_PERMISSIONS: {
                ...
                if (perms.get(Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED
                    ...
                    // Permission Denied
                    Toast.makeText(BleScannerActivity.this, "All Permission GRANTED !! Thank You :)", Toast.LENGTH_SHORT)
                            .show();


                } else {
                    // Permission Denied
                    Toast.makeText(BleScannerActivity.this, "One or More Permissions are DENIED Exiting App :(", Toast.LENGTH_SHORT)
                            .show();
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        ...
        new AlertDialog.Builder(BleScannerActivity.this)
                .setTitle("Adding permissions")
                .setMessage(message)
